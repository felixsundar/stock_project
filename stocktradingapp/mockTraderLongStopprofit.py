...
def setupUserMaps(user_zerodha):
    ...
    live_monitor[user_zerodha.user_id] = LiveMonitor(hstock_user=test_user, user_id='Long Stopprofit',
...
def sendStatusEmailLongStopprofit():
    ...
    try:
        ...
        monitor_status = 'Status for Mock Long Stopprofit at time : ' + str(now()) \
        ...
        x=send_mail(subject='Mock Long Stopprofit Status', message=monitor_status,
